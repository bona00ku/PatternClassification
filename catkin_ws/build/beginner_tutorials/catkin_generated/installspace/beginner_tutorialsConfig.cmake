...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hjku/workspace/3rdparty/catkin_ws/install/${idir}'.  Ask the maintainer 'hjku <hjku@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hjku/workspace/3rdparty/catkin_ws/install/lib;/home/hjku/workspace/3rdparty/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
